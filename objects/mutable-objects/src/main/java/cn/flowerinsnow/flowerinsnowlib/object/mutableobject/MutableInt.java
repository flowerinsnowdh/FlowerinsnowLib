...
public class MutableInt {
    ...
    /// 指定值的构造器
    /// @param value 值
    protected MutableInt(int value) {
        this.value = value;
    }
    ...
    public static @NotNull MutableInt create(int value) {
    ...
    public @NotNull MutableInt set(int value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", MutableInt.class.getSimpleName() + "[", "]")
