...
/// 可在任意地方改变的共享 `double` 值，类似指针的读值与写值
...
public class MutableDouble {
    ...
    /// 指定值的构造器
    /// @param value 值
    protected MutableDouble(double value) {
        this.value = value;
    }
    ...
    public static @NotNull MutableDouble create(double value) {
    ...
    public @NotNull MutableDouble set(double value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", MutableDouble.class.getSimpleName() + "[", "]")
