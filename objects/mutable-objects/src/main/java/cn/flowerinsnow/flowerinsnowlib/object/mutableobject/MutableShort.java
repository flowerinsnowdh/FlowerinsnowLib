...
/// 可在任意地方改变的共享 `short` 值，类似指针的读值与写值
...
public class MutableShort {
    ...
    /// 指定值的构造器
    /// @param value 值
    protected MutableShort(short value) {
        this.value = value;
    }
    ...
    public static @NotNull MutableShort create(short value) {
    ...
    public @NotNull MutableShort set(short value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", MutableShort.class.getSimpleName() + "[", "]")
