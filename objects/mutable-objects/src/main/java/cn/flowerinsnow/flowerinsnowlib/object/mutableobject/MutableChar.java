...
public class MutableChar {
    ...
    /// 指定值的构造器
    /// @param value 值
    protected MutableChar(char value) {
        this.value = value;
    }
    ...
    public static @NotNull MutableChar create(char value) {
    ...
    public @NotNull MutableChar set(char value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", MutableChar.class.getSimpleName() + "[", "]")
